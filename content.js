...
const portfolio = {
  ...
  github: "https://gitee.com/lsz_nb/zuopin",
  csdn: "https://blog.csdn.net/2603_96777453?type=blog",
  gitee: "https://gitee.com/lsz_nb/zuopin",
  resumeUrl: "",
  studyHours: "180+",
  skillCount: "06",
  about: "我正在系统学习 Python 数据采集与自动化。每个项目都从一个具体问题出发，完成从抓取、清洗到可视化展示的完整流程。",
  skills: ["Python", "Requests", "Beautiful Soup", "DrissionPage", "Pandas", "SQL",'C/C++'],
  projects: [
    ...
    { category: "creative", number: "19", title: "皇室战争ai开发", description: "皇室战争", tags: ["game", "clash","royal"], link: "Portfolio/炫酷项目展示.html", accent: "coral", bgImage: "Portfolio/bgimgs/img.png"}
  ]
};
